 ...
 * 
 * <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< */
#ifndef dilloxl_ui_attitude_h
#define dilloxl_ui_attitude_h
...
namespace dilloxl {
  ...
  public:
    GuiAttitude();
    GuiAttitude(const GuiAttitude&) = delete;
    GuiAttitude(GuiAttitude&&) noexcept;
    GuiAttitude& operator=(const GuiAttitude&) = delete;
    GuiAttitude& operator=(GuiAttitude&&) noexcept;
    virtual ~GuiAttitude();
    virtual void draw();
  private:

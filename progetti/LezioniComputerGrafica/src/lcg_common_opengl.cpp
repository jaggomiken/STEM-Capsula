 ...
 * DATI STATICI
 * <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< */
static std::unordered_map<std::string, lcg::OpenGLAppModule::ModuleCode> gMapMC;

/* <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
 * DEFINIZIONE FUNZIONE/METODO
 * <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< */
void lcg::OpenGLAppModule::Register(const std::string& n, const ModuleCode& mc)
{
  gMapMC[n] = mc;
}
 ...
 * DEFINIZIONE FUNZIONE/METODO
 * <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< */
void lcg::OpenGLAppModule::RunAll(ApplicationContext& ac)
{
